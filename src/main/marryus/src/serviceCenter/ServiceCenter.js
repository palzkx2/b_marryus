...
const ServiceCenter = () => {
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: "연회 행사명 또는 주최자나 주최 회사명으로 확인이 가능합니다. 당일 행사는 Instant Service Center로 바로 확인이 가능합니다만 , 이후 날짜의 행사 확인은 연회세일즈(558-7778)에서 가능합니다."
        },
        {
        ...
        },
        {
            ...
            answer: "식 음료 부분에 대해서 봉사료 10%와 세금 10%가 포함되어 있습니다. 기타 식음료 부분을 제외한 대관료, A/V장비, 꽃장식 등에 대한 사용은 10% 세금만 포함됩니다."
        },
        {
