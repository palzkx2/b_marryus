  ...
  // 결제 요청 함수
    const requestPayment = () => {
      ...
      PortOne.requestPayment({
        ...
        paymentId, // 결제 ID, 40자 이내로 설정
        orderName: "나이키 와플 트레이너 2 SD", // 주문명
        totalAmount: 1000, // 결제 금액
        currency: "CURRENCY_KRW", // 결제 통화
        payMethod: paymentMethod, // 결제 방법
        customer: {
          fullName: memberInfo.memName,// 고객 이름
          phoneNumber: memberInfo.tel, // 고객 전화번호
          email: memberInfo.email, // 고객 이메일
        },
      }).then(response => {
