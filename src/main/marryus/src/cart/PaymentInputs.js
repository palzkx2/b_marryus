    ...
    return (
        <div>
           <div className='reservationInformation' style={{ width: '90%', maxWidth: '472px', height: '414px', margin: '0 auto', padding: '20px' }}>
               <h3 className='ritems'>예약 정보 입력</h3>
               ...
               <div className='ritemsName' style={{ display: 'flex', justifyContent: 'space-between', margin: '15px 0' }}>
                   <div style={{ display: 'flex', flexDirection: 'column', width: '48%' }}>
                       ...
                       <input name='englishName' value={formData.englishName} onChange={changeInput} placeholder='gildong' style={{ width: '100%', height: '30px', padding: '5px' }} /> {/* 수정한데이터 */}
                   </div>
                   <div style={{ display: 'flex', flexDirection: 'column', width: '48%' }}>
                       <label style={{ marginBottom: '5px' }}>영문 성</label>
                       <input name='englishFamilyName' value={formData.englishFamilyName} onChange={changeInput} placeholder='hong' style={{ width: '100%', height: '30px', padding: '5px' }} /> {/* 수정한데이터 */}
                   </div>
               </div>
               ...
               <div className='ritemsEmail' style={{ display: 'flex', flexDirection: 'column', margin: '15px 0' }}>
                   ...
                   <input name='email' value={formData.email} onChange={changeInput} placeholder='email@example.com' style={{ width: '100%', height: '30px', padding: '5px' }} />
               </div>

               <div className='ritemsPhone' style={{ display: 'flex', flexDirection: 'column', margin: '15px 0' }}>
                   <label style={{ marginBottom: '5px' }}>번호</label>
                   <input name='phone' value={formData.phone} onChange={changeInput} placeholder='010-0000-0000' style={{ width: '100%', height: '30px', padding: '5px' }} />
               </div>
               <div className='lastButton'>
                   <button onClick={ssgOrderConfirm} className='lastBtn' style={{
                       display: 'flex',
