...
import ReviewRing from './ReviewSdm';
import { useHistory } from 'react-router-dom/cjs/react-router-dom.min';

const SdmReviewList = ({ item }) => {
    ...
    return (
        ...
        <div className="sdmreview-container" style={{ width: '100%', maxWidth: '1400px', padding: '20px' }}> 
            <div className='weddingItemReview-review' style={{ marginBottom: '20px',  }}> 
                <h2>리뷰 목록</h2>
                <div className='reviews-length' style={{ display: 'flex',marginLeft:'5px', padding: '5px 10px', borderRadius: '5px' }}> 
