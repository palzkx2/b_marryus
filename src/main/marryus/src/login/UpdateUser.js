            ...
            <div style={{display:'flex', justifyContent:'center', alignContent:'center'}}>
                <div style={{width:'1400px', height:'700px', background:'#FFE4E1'}}>
                    ...
                    <div style={{width:'1050px', height:'50px', background:'none', position:'absolute', margin:'0 70px 0 270px', top:'564px', borderTop:'1px solid gray', borderBottom:'1px solid rgba(0,0,0,0.1)', alignContent:'center'}}>
                        <input type='text' style={{marginLeft:'20px', color:'rgba(0,0,0,0.4'}} disabled='disabled' value={'abcde'}/> @ <input type='text' style={{width:'90px', color:'rgba(0,0,0,0.4'}} disabled='disabled' value={'naver.com'}/>
                        <select style={{marginLeft:'10px', fontSize:'9pt', height:'19px', color:'rgba(0,0,0,0.4'}} disabled='disabled'>
                            <option>직접입력</option>
