        ...
        <div>
            ...
            <div style={{display:'flex', justifyContent:'center', alignContent:'center'}}>
                <div style={{width:'1400px', height:'700px', background:'#FFE4E1'}}>
                    ...
                    <div style={{width:'1050px', height:'50px', background:'none', position:'absolute', margin:'0 70px 0 270px', top:'979px', borderBottom:'1px solid gray', alignContent:'center', marginTop:83}}>
